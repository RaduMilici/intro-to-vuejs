...
export const ONE_WAY_DATA_IMG_SRC = "https://i.imgur.com/2GqA9eY.png";
export const PROP_VALIDATION_IMG_SRC = "https://i.imgur.com/75Aggqh.png";
...
export const DYNAMIC_COMP_BASIC_IFRAME_SRC = `${embed}989zwz55mr?fontsize=14&module=%2Findex.html`;
export const PROPS_VALIDATION_IFRAME_SRC = `${embed}212qp237jj?fontsize=14&module=%2Findex.html`;
export const SLOTS_NAMED_IFRAME_SRC = `${embed}zqjp7l8lrm?fontsize=14&module=%2Findex.html`;
